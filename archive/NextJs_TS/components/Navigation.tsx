...
const Navigation = (props: any) => {
  ...
  return (
    <div id="navigation">
      ...
      <nav
        id="mobile-nav"
        className={`fixed bottom-0 backdrop-blur-sm z-50 max-h-40 w-full py-2 transition-all ease-in md:hidden ${show
      ...
      >
        <div className="flex items-center justify-evenly text-white">
          <Link 
            ...
            href="/" 
            title="Home"
            className="flex flex-col items-center justify-center text-2xl hover:text-green-400"
          >
              <svg
      ...
      <nav
        id="desktop-nav"
        className={`fixed top-0 z-50 hidden h-16 w-full backdrop-blur-sm transition-all ease-in md:flex ${show
            ? 'bg-main shadow-0_8px_32px_0_rgba(31,38,135,0.37)]'
            : 'bg-transparent'
          }`}
      >
        ...
        <div className="flex grow items-center justify-center space-x-3">
          <Link 
            ...
            passHref 
            title="Home"
            className="p-1 text-2xl capitalize text-white transition-all ease-in hover:text-green-400"
          >
            Home
          </Link>
          <Link
          ...
          <Link 
            passHref 
            href="https://blog.swayechateau.com" 
            target="_blank" className="p-1 text-2xl capitalize text-white transition-all ease-in hover:text-green-400"
          >
            Blog
          </Link>
        </div>
