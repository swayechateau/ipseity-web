defmodule IpseityWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(IpseityWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(IpseityWeb.Gettext, "errors", msg, opts)
    end
  end
